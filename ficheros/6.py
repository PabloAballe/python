...
def main():
    ...
    with open(ruta, mode="w", encoding="utf-8") as fichero:
        ...
        print(' <line x1="310" y1="0" x2="310" y2="320" stroke-width="2" stroke="red" />', file=fichero)
        print(' <line x1="0" y1="160" x2="620" y2="160" stroke-width="2" stroke="red" />', file=fichero)
