...
def main():
    ...
    with open(ruta, mode="w", encoding="utf-8") as fichero:
        ...
        print(' <line x1="10" y1="10" x2="200" y2="120" stroke-width="1" stroke="chocolate" />', file=fichero)
        print(' <line x1="610" y1="5" x2="400" y2="120" stroke-width="1" stroke="chocolate" />', file=fichero)
        #print(' <line x1="10" y1="10" x2="200" y2="120" stroke-width="1" stroke="chocolate" />', file=fichero)
        #print(' <line x1="10" y1="10" x2="200" y2="120" stroke-width="1" stroke="chocolate" />', file=fichero)
